...
exports.register = async (req, res) => {
  ...
  try {
    ...
    res
      .status(201)
      .json({ message: "Register successfully, Please verify OTP." });
  } catch (err) {
...
/**
 * Forgot Password => requestResetPassword => verifyResetPasswordOTP => setNewPassword => login
 * @param {*} req
 * @param {*} res
 * @returns
 */
...
exports.requestResetPassword = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "OTP sent to your email for resets password." });
  } catch (err) {
...
exports.verifyResetPasswordOTP = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ message: "OTP verified successfully, Please set new password." });
  } catch (err) {
...
/**
 * User profile => getUserProfile => updateProfile 
 * @param {*} req 
 * @param {*} res 
 */
